    ...
    def _build_parser(self):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                'https://neo4j.com/docs/python-manual/current/client-applications/#python-driver-connection-uris '
                'for complete documentation on the structure of a Neo4j URI.'
            ),
        )
        parser.add_argument(
            '--neo4j-user',
